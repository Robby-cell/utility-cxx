...
struct sentinel_iterator {
  friend constexpr bool operator==(sentinel_iterator,
                                   sentinel_iterator) noexcept {
    return true;
  }
  ...
  sentinel_iterator &operator++() noexcept { return *this; }

  sentinel_iterator operator++(int) noexcept { return *this; }
